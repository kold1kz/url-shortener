...
const file_proto_shortener_proto_rawDesc = "" +
	...
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x1b.shortener.UserURLsResponse\x12:\n" +
	"\x05Login\x12\x17.shortener.LoginRequest\x1a\x18.shortener.LoginResponseB\x15Z\x13url-shortener/protob\beditionsp\xe8\a"
...
var file_proto_shortener_proto_goTypes = []any{
	...
	(*LoginRequest)(nil),       // 6: shortener.LoginRequest
	(*LoginResponse)(nil),      // 7: shortener.LoginResponse
...
var file_proto_shortener_proto_depIdxs = []int32{
	...
	8, // 3: shortener.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	6, // 4: shortener.ShortenerService.Login:input_type -> shortener.LoginRequest
	1, // 5: shortener.ShortenerService.ShortenURL:output_type -> shortener.URLShortenResponse
	3, // 6: shortener.ShortenerService.ExpandURL:output_type -> shortener.URLExpandResponse
	4, // 7: shortener.ShortenerService.ListUserURLs:output_type -> shortener.UserURLsResponse
	7, // 8: shortener.ShortenerService.Login:output_type -> shortener.LoginResponse
